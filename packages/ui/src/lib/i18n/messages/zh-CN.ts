...
export const dict: Record<I18nKey, string> = {
  ...
  'contextRail.surface.notes.description': '项目的 Atomic 保管库意图与派生记忆',
  ...
  'contextRail.surface.atomic.description': '检查只读 Atomic 仓库',
  'contextRail.surface.provenance.description': '追踪某项更改的完整来源链',
  'atomic.provenanceChain.title': '来源链',
  'atomic.provenanceChain.tabLabel': '来源 {hash}',
  'atomic.provenanceChain.open': '打开来源链',
  'atomic.ledger.kind.goal': '目标',
  'atomic.ledger.kind.exploration': '探索',
  'atomic.ledger.kind.execution': '执行',
  'atomic.ledger.kind.commitment': '提交',
  'atomic.ledger.kind.todo': '待办',
  'atomic.ledger.kind.verification': '验证',
  'atomic.ledger.kind.patchProposal': '补丁提案',
  'atomic.ledger.kind.llmResponse': '响应',
  'atomic.ledger.agentWithVendor': '{agent}（{vendor}）',
  'atomic.ledger.counts': '{nodes} 个节点 · {edges} 条边 · {changes} 项更改',
  'atomic.ledger.noNodes': '本轮未记录决策节点。',
  'atomic.ledger.empty.title': '无来源链',
  'atomic.ledger.empty.description': '此更改没有记录的决策账本。',
  'atomic.title': 'Atomic 仓库',
  'atomic.action.refresh': '刷新',
  'atomic.section.changes': '更改',
  'atomic.section.history': '历史记录',
  'atomic.section.provenance': '来源',
  'atomic.vault.section.intents': '意图',
  'atomic.vault.section.otherMemories': '其他记忆',
  'atomic.vault.derivedMemories': '派生记忆',
  'atomic.vault.derivedCount': '派生 {count} 条',
  'atomic.vault.attested': '已证明',
  'atomic.vault.field.why': '原因',
  'atomic.vault.field.acceptanceCriteria': '验收标准',
  'atomic.vault.field.tasks': '任务',
  'atomic.vault.field.scopeIn': '范围内',
  'atomic.vault.field.scopeOut': '范围外',
  'atomic.vault.field.constraints': '约束',
  'atomic.vault.field.verifiedBy': '验证者：{value}',
  'atomic.vault.field.evidence': '证据：{value}',
  'atomic.vault.loading': '正在加载保管库…',
  'atomic.vault.noProject': '打开一个项目以查看其保管库。',
  'atomic.vault.empty.title': '保管库为空',
  'atomic.vault.empty.description': '此项目没有记录任何意图或记忆。',
  'atomic.views.pickerLabel': '选择视图',
  'atomic.views.none': '无视图',
  'atomic.view.current': '当前',
  'atomic.view.changeCount': '更改：{count}',
  'atomic.status.added': '已添加',
  'atomic.status.modified': '已修改',
  'atomic.status.deleted': '已删除',
  'atomic.status.renamed': '已重命名',
  'atomic.status.untracked': '未跟踪',
  'atomic.status.conflicted': '冲突',
  'atomic.change.sequence': '序号 {sequence}',
  'atomic.change.hash': '更改',
  'atomic.change.author': '作者',
  'atomic.change.state': '状态',
  'atomic.section.attestation': '证明',
  'atomic.attestation.vendor': '供应商',
  'atomic.attestation.model': '模型',
  'atomic.attestation.tool': '工具',
  'atomic.attestation.type': '类型',
  'atomic.attestation.tokens': '令牌',
  'atomic.attestation.tokensValue': '输入 {input} · 输出 {output} · 合计 {total}',
  'atomic.attestation.cost': '成本',
  'atomic.attestation.session': '会话',
  'atomic.attestation.finishReason': '结束原因',
  'atomic.attestation.steps': '步骤',
  'atomic.attestation.metadata': '元数据',
  'atomic.state.loading': '正在加载 Atomic 仓库…',
  'atomic.state.initialError.title': '无法加载 Atomic 仓库',
  'atomic.state.initialError.description': '请检查仓库并重试。',
  'atomic.state.refreshError': '刷新失败。仍显示之前加载的仓库数据。',
  'atomic.state.clean': '工作副本没有更改。',
  'atomic.state.noHistory': '此视图中没有记录的更改。',
  'atomic.state.loadingDetail': '正在加载更改详情…',
  'atomic.state.noDiff': '没有可用的补丁。',
  'atomic.state.loadingProvenance': '正在加载来源…',
  'atomic.state.noProvenance': '此更改没有可用的来源信息。',
  'atomic.state.selectChange': '选择工作路径或历史更改以检查其补丁。',
  'atomic.unavailable.cli.title': '未安装 Atomic CLI',
  'atomic.unavailable.cli.description': '请安装 Atomic 以检查此仓库。',
  'atomic.unavailable.repository.title': '这不是 Atomic 仓库',
  'atomic.unavailable.repository.description': '请打开已初始化为 Atomic 仓库的目录。',
  'atomic.unavailable.unsupported.title': '此运行环境不支持 Atomic',
  'atomic.unavailable.unsupported.description': '请使用支持 Atomic 只读访问的运行环境。',
  'atomic.unavailable.error.title': 'Atomic 仓库不可用',
  'atomic.unavailable.error.description': '无法检查该仓库。',
  'vscodeLayout.actions.atomicAria': '打开 Atomic 仓库',
