...
export const dict: Record<I18nKey, string> = {
  ...
  'contextRail.surface.notes.description': 'プロジェクトの Atomic ボールトのインテントと派生メモリ',
  ...
  'contextRail.surface.atomic.description': '読み取り専用の Atomic リポジトリを確認',
  'contextRail.surface.provenance.description': '変更の完全な来歴チェーンをたどる',
  'atomic.provenanceChain.title': '来歴チェーン',
  'atomic.provenanceChain.tabLabel': '来歴 {hash}',
  'atomic.provenanceChain.open': '来歴チェーンを開く',
  'atomic.ledger.kind.goal': '目標',
  'atomic.ledger.kind.exploration': '調査',
  'atomic.ledger.kind.execution': '実行',
  'atomic.ledger.kind.commitment': 'コミット',
  'atomic.ledger.kind.todo': 'ToDo',
  'atomic.ledger.kind.verification': '検証',
  'atomic.ledger.kind.patchProposal': 'パッチ提案',
  'atomic.ledger.kind.llmResponse': '応答',
  'atomic.ledger.agentWithVendor': '{agent}（{vendor}）',
  'atomic.ledger.counts': 'ノード {nodes} · エッジ {edges} · 変更 {changes}',
  'atomic.ledger.noNodes': 'このターンでは決定ノードは記録されませんでした。',
  'atomic.ledger.empty.title': '来歴チェーンなし',
  'atomic.ledger.empty.description': 'この変更には記録された決定台帳がありません。',
  'atomic.title': 'Atomic リポジトリ',
  'atomic.action.refresh': '更新',
  'atomic.section.changes': '変更',
  'atomic.section.history': '履歴',
  'atomic.section.provenance': '来歴',
  'atomic.vault.section.intents': 'インテント',
  'atomic.vault.section.otherMemories': 'その他のメモリ',
  'atomic.vault.derivedMemories': '派生メモリ',
  'atomic.vault.derivedCount': '派生 {count} 件',
  'atomic.vault.attested': '証明済み',
  'atomic.vault.field.why': '理由',
  'atomic.vault.field.acceptanceCriteria': '受け入れ基準',
  'atomic.vault.field.tasks': 'タスク',
  'atomic.vault.field.scopeIn': '対象範囲',
  'atomic.vault.field.scopeOut': '対象外',
  'atomic.vault.field.constraints': '制約',
  'atomic.vault.field.verifiedBy': '検証者: {value}',
  'atomic.vault.field.evidence': '根拠: {value}',
  'atomic.vault.loading': 'ボールトを読み込んでいます…',
  'atomic.vault.noProject': 'ボールトを表示するにはプロジェクトを開いてください。',
  'atomic.vault.empty.title': 'ボールトは空です',
  'atomic.vault.empty.description': 'このプロジェクトには記録されたインテントやメモリがありません。',
  ...
  'atomic.status.deleted': '削除',
  'atomic.status.renamed': '名前変更',
  ...
  'atomic.section.attestation': '証明',
  'atomic.attestation.vendor': 'ベンダー',
  'atomic.attestation.model': 'モデル',
  'atomic.attestation.tool': 'ツール',
  'atomic.attestation.type': 'タイプ',
  'atomic.attestation.tokens': 'トークン',
  'atomic.attestation.tokensValue': '入力 {input} · 出力 {output} · 合計 {total}',
  'atomic.attestation.cost': 'コスト',
  'atomic.attestation.session': 'セッション',
  'atomic.attestation.finishReason': '終了理由',
  'atomic.attestation.steps': 'ステップ',
  'atomic.attestation.metadata': 'メタデータ',
  'atomic.state.loading': 'Atomic リポジトリを読み込んでいます…',
  'atomic.state.initialError.title': 'Atomic リポジトリを読み込めませんでした',
  'atomic.state.initialError.description': 'リポジトリを確認して、もう一度お試しください。',
  'atomic.state.refreshError': '更新に失敗しました。以前に読み込んだデータを表示しています。',
  'atomic.state.clean': '作業コピーに変更はありません。',
  'atomic.state.noHistory': 'このビューには変更履歴がありません。',
  'atomic.state.loadingDetail': '変更の詳細を読み込んでいます…',
  'atomic.state.noDiff': 'パッチはありません。',
  'atomic.state.loadingProvenance': '来歴を読み込んでいます…',
  'atomic.state.noProvenance': 'この変更の来歴はありません。',
  'atomic.state.selectChange': '作業パスまたは過去の変更を選択してパッチを確認してください。',
  'atomic.unavailable.cli.title': 'Atomic CLI がインストールされていません',
  'atomic.unavailable.cli.description': 'このリポジトリを確認するには Atomic をインストールしてください。',
  'atomic.unavailable.repository.title': 'Atomic リポジトリではありません',
  'atomic.unavailable.repository.description': 'Atomic リポジトリとして初期化されたディレクトリを開いてください。',
  'atomic.unavailable.unsupported.title': 'このランタイムでは Atomic を利用できません',
  'atomic.unavailable.unsupported.description': 'Atomic の読み取り専用アクセスに対応したランタイムを使用してください。',
  'atomic.unavailable.error.title': 'Atomic リポジトリを利用できません',
  'atomic.unavailable.error.description': 'リポジトリを確認できませんでした。',
  'vscodeLayout.actions.atomicAria': 'Atomic リポジトリを開く',
