...
export const dict = {
  ...
  'contextRail.surface.notes.description': 'Intentions du coffre Atomic et mémoires dérivées pour le projet',
  ...
  'contextRail.surface.atomic.description': 'Examiner le dépôt Atomic en lecture seule',
  'contextRail.surface.provenance.description': 'Suivre la chaîne de provenance complète d\u2019une modification',
  'atomic.provenanceChain.title': 'Chaîne de provenance',
  'atomic.provenanceChain.tabLabel': 'Provenance {hash}',
  'atomic.provenanceChain.open': 'Ouvrir la chaîne de provenance',
  'atomic.ledger.kind.goal': 'Objectif',
  'atomic.ledger.kind.exploration': 'Exploration',
  'atomic.ledger.kind.execution': 'Exécution',
  'atomic.ledger.kind.commitment': 'Engagement',
  'atomic.ledger.kind.todo': 'Tâche',
  'atomic.ledger.kind.verification': 'Vérification',
  'atomic.ledger.kind.patchProposal': 'Proposition de correctif',
  'atomic.ledger.kind.llmResponse': 'Réponse',
  'atomic.ledger.agentWithVendor': '{agent} ({vendor})',
  'atomic.ledger.counts': '{nodes} nœuds · {edges} arêtes · {changes} modifications',
  'atomic.ledger.noNodes': 'Ce tour n\u2019a enregistré aucun nœud de décision.',
  'atomic.ledger.empty.title': 'Aucune chaîne de provenance',
  'atomic.ledger.empty.description': 'Cette modification n\u2019a aucun journal de décisions enregistré.',
  'atomic.title': 'Dépôt Atomic',
  'atomic.action.refresh': 'Actualiser',
  'atomic.section.changes': 'Modifications',
  'atomic.section.history': 'Historique',
  'atomic.section.provenance': 'Provenance',
  'atomic.vault.section.intents': 'Intentions',
  'atomic.vault.section.otherMemories': 'Autres mémoires',
  'atomic.vault.derivedMemories': 'Mémoires dérivées',
  'atomic.vault.derivedCount': '{count} dérivées',
  'atomic.vault.attested': 'Attestée',
  'atomic.vault.field.why': 'Pourquoi',
  'atomic.vault.field.acceptanceCriteria': 'Critères d’acceptation',
  'atomic.vault.field.tasks': 'Tâches',
  'atomic.vault.field.scopeIn': 'Dans le périmètre',
  'atomic.vault.field.scopeOut': 'Hors périmètre',
  'atomic.vault.field.constraints': 'Contraintes',
  'atomic.vault.field.verifiedBy': 'Vérifié par : {value}',
  'atomic.vault.field.evidence': 'Preuve : {value}',
  'atomic.vault.loading': 'Chargement du coffre…',
  'atomic.vault.noProject': 'Ouvrez un projet pour afficher son coffre.',
  'atomic.vault.empty.title': 'Le coffre est vide',
  'atomic.vault.empty.description': 'Aucune intention ni mémoire n’est enregistrée pour ce projet.',
  'atomic.views.pickerLabel': 'Sélectionner une vue',
  'atomic.views.none': 'Aucune vue',
  'atomic.view.current': 'Actuelle',
  'atomic.view.changeCount': 'Modifications : {count}',
  'atomic.status.added': 'Ajouté',
  'atomic.status.modified': 'Modifié',
  'atomic.status.deleted': 'Supprimé',
  'atomic.status.renamed': 'Renommé',
  ...
  'atomic.section.attestation': 'Attestation',
  'atomic.attestation.vendor': 'Fournisseur',
  'atomic.attestation.model': 'Modèle',
  'atomic.attestation.tool': 'Outil',
  'atomic.attestation.type': 'Type',
  'atomic.attestation.tokens': 'Jetons',
  'atomic.attestation.tokensValue': 'Entrée {input} · Sortie {output} · Total {total}',
  'atomic.attestation.cost': 'Coût',
  'atomic.attestation.session': 'Session',
  'atomic.attestation.finishReason': 'Motif de fin',
  'atomic.attestation.steps': 'Étapes',
  'atomic.attestation.metadata': 'Métadonnées',
  'atomic.state.loading': 'Chargement du dépôt Atomic…',
  'atomic.state.initialError.title': 'Impossible de charger le dépôt Atomic',
  'atomic.state.initialError.description': 'Vérifiez le dépôt puis réessayez.',
  'atomic.state.refreshError': 'Échec de l’actualisation. Les données précédemment chargées restent affichées.',
  'atomic.state.clean': 'La copie de travail est propre.',
  'atomic.state.noHistory': 'Aucune modification n’est enregistrée dans cette vue.',
  'atomic.state.loadingDetail': 'Chargement des détails de la modification…',
  'atomic.state.noDiff': 'Aucun correctif n’est disponible.',
  'atomic.state.loadingProvenance': 'Chargement de la provenance…',
  'atomic.state.noProvenance': 'Aucune provenance n’est disponible pour cette modification.',
  'atomic.state.selectChange': 'Sélectionnez un chemin de travail ou une modification historique pour examiner son correctif.',
  'atomic.unavailable.cli.title': 'La CLI Atomic n’est pas installée',
  'atomic.unavailable.cli.description': 'Installez Atomic pour examiner ce dépôt.',
  'atomic.unavailable.repository.title': 'Ce dossier n’est pas un dépôt Atomic',
  'atomic.unavailable.repository.description': 'Ouvrez un dossier initialisé comme dépôt Atomic.',
  'atomic.unavailable.unsupported.title': 'Atomic n’est pas disponible dans cet environnement',
  'atomic.unavailable.unsupported.description': 'Utilisez un environnement prenant en charge l’accès Atomic en lecture seule.',
  'atomic.unavailable.error.title': 'Le dépôt Atomic n’est pas disponible',
  'atomic.unavailable.error.description': 'Le dépôt n’a pas pu être examiné.',
  'vscodeLayout.actions.atomicAria': 'Ouvrir le dépôt Atomic',
