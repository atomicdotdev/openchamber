...
export const dict: Record<I18nKey, string> = {
  ...
  'contextRail.surface.notes.description': '專案的 Atomic 保存庫意圖與衍生記憶',
  ...
  'contextRail.surface.atomic.description': '檢查唯讀 Atomic 儲存庫',
  'contextRail.surface.provenance.description': '追蹤某項變更的完整來源鏈',
  'atomic.provenanceChain.title': '來源鏈',
  'atomic.provenanceChain.tabLabel': '來源 {hash}',
  'atomic.provenanceChain.open': '開啟來源鏈',
  'atomic.ledger.kind.goal': '目標',
  'atomic.ledger.kind.exploration': '探索',
  'atomic.ledger.kind.execution': '執行',
  'atomic.ledger.kind.commitment': '提交',
  'atomic.ledger.kind.todo': '待辦',
  'atomic.ledger.kind.verification': '驗證',
  'atomic.ledger.kind.patchProposal': '修補提案',
  'atomic.ledger.kind.llmResponse': '回應',
  'atomic.ledger.agentWithVendor': '{agent}（{vendor}）',
  'atomic.ledger.counts': '{nodes} 個節點 · {edges} 條邊 · {changes} 項變更',
  'atomic.ledger.noNodes': '本輪未記錄決策節點。',
  'atomic.ledger.empty.title': '無來源鏈',
  'atomic.ledger.empty.description': '此變更沒有記錄的決策帳本。',
  'atomic.title': 'Atomic 儲存庫',
  'atomic.action.refresh': '重新整理',
  'atomic.section.changes': '變更',
  'atomic.section.history': '歷程記錄',
  'atomic.section.provenance': '來源',
  'atomic.vault.section.intents': '意圖',
  'atomic.vault.section.otherMemories': '其他記憶',
  'atomic.vault.derivedMemories': '衍生記憶',
  'atomic.vault.derivedCount': '衍生 {count} 筆',
  'atomic.vault.attested': '已證明',
  'atomic.vault.field.why': '原因',
  'atomic.vault.field.acceptanceCriteria': '驗收標準',
  'atomic.vault.field.tasks': '任務',
  'atomic.vault.field.scopeIn': '範圍內',
  'atomic.vault.field.scopeOut': '範圍外',
  'atomic.vault.field.constraints': '限制',
  'atomic.vault.field.verifiedBy': '驗證者：{value}',
  'atomic.vault.field.evidence': '證據：{value}',
  'atomic.vault.loading': '正在載入保存庫…',
  'atomic.vault.noProject': '開啟一個專案以檢視其保存庫。',
  'atomic.vault.empty.title': '保存庫是空的',
  'atomic.vault.empty.description': '此專案沒有記錄任何意圖或記憶。',
  ...
  'atomic.status.deleted': '已刪除',
  'atomic.status.renamed': '已重新命名',
  'atomic.status.untracked': '未追蹤',
  'atomic.status.conflicted': '衝突',
  'atomic.change.sequence': '序號 {sequence}',
  'atomic.change.hash': '變更',
  'atomic.change.author': '作者',
  'atomic.change.state': '狀態',
  'atomic.section.attestation': '證明',
  'atomic.attestation.vendor': '供應商',
  'atomic.attestation.model': '模型',
  'atomic.attestation.tool': '工具',
  'atomic.attestation.type': '類型',
  'atomic.attestation.tokens': '權杖',
  'atomic.attestation.tokensValue': '輸入 {input} · 輸出 {output} · 總計 {total}',
  'atomic.attestation.cost': '成本',
  'atomic.attestation.session': '工作階段',
  'atomic.attestation.finishReason': '結束原因',
  'atomic.attestation.steps': '步驟',
  'atomic.attestation.metadata': '中繼資料',
  'atomic.state.loading': '正在載入 Atomic 儲存庫…',
  'atomic.state.initialError.title': '無法載入 Atomic 儲存庫',
  'atomic.state.initialError.description': '請檢查儲存庫後再試一次。',
  'atomic.state.refreshError': '重新整理失敗。仍顯示先前載入的儲存庫資料。',
  'atomic.state.clean': '工作副本沒有變更。',
  'atomic.state.noHistory': '此檢視中沒有記錄的變更。',
  'atomic.state.loadingDetail': '正在載入變更詳細資料…',
  'atomic.state.noDiff': '沒有可用的修補檔。',
  'atomic.state.loadingProvenance': '正在載入來源…',
  'atomic.state.noProvenance': '此變更沒有可用的來源資訊。',
  'atomic.state.selectChange': '選取工作路徑或歷史變更以檢查其修補檔。',
  'atomic.unavailable.cli.title': '尚未安裝 Atomic CLI',
  'atomic.unavailable.cli.description': '請安裝 Atomic 以檢查此儲存庫。',
  'atomic.unavailable.repository.title': '這不是 Atomic 儲存庫',
  'atomic.unavailable.repository.description': '請開啟已初始化為 Atomic 儲存庫的目錄。',
  'atomic.unavailable.unsupported.title': '此執行環境不支援 Atomic',
  'atomic.unavailable.unsupported.description': '請使用支援 Atomic 唯讀存取的執行環境。',
  'atomic.unavailable.error.title': 'Atomic 儲存庫無法使用',
  'atomic.unavailable.error.description': '無法檢查該儲存庫。',
  'vscodeLayout.actions.atomicAria': '開啟 Atomic 儲存庫',
