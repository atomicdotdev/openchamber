...
export const dict: Record<I18nKey, string> = {
  ...
  "contextRail.surface.notes.description": "Intenções do repositório Atomic e memórias derivadas do projeto",
  ...
  'contextRail.surface.atomic.description': 'Inspecionar o repositório Atomic somente para leitura',
  'contextRail.surface.provenance.description': 'Seguir a cadeia de proveniência completa de uma alteração',
  'atomic.provenanceChain.title': 'Cadeia de proveniência',
  'atomic.provenanceChain.tabLabel': 'Proveniência {hash}',
  'atomic.provenanceChain.open': 'Abrir a cadeia de proveniência',
  'atomic.ledger.kind.goal': 'Objetivo',
  'atomic.ledger.kind.exploration': 'Exploração',
  'atomic.ledger.kind.execution': 'Execução',
  'atomic.ledger.kind.commitment': 'Compromisso',
  'atomic.ledger.kind.todo': 'Tarefa',
  'atomic.ledger.kind.verification': 'Verificação',
  'atomic.ledger.kind.patchProposal': 'Proposta de patch',
  'atomic.ledger.kind.llmResponse': 'Resposta',
  'atomic.ledger.agentWithVendor': '{agent} ({vendor})',
  'atomic.ledger.counts': '{nodes} nós · {edges} arestas · {changes} alterações',
  'atomic.ledger.noNodes': 'Este turno não registrou nós de decisão.',
  'atomic.ledger.empty.title': 'Sem cadeia de proveniência',
  'atomic.ledger.empty.description': 'Esta alteração não tem um registro de decisões.',
  'atomic.title': 'Repositório Atomic',
  'atomic.action.refresh': 'Atualizar',
  'atomic.section.changes': 'Alterações',
  'atomic.section.history': 'Histórico',
  'atomic.section.provenance': 'Procedência',
  "atomic.vault.section.intents": "Intenções",
  "atomic.vault.section.otherMemories": "Outras memórias",
  "atomic.vault.derivedMemories": "Memórias derivadas",
  "atomic.vault.derivedCount": "{count} derivadas",
  "atomic.vault.attested": "Atestada",
  "atomic.vault.field.why": "Motivo",
  "atomic.vault.field.acceptanceCriteria": "Critérios de aceitação",
  "atomic.vault.field.tasks": "Tarefas",
  "atomic.vault.field.scopeIn": "No escopo",
  "atomic.vault.field.scopeOut": "Fora do escopo",
  "atomic.vault.field.constraints": "Restrições",
  "atomic.vault.field.verifiedBy": "Verificado por: {value}",
  "atomic.vault.field.evidence": "Evidência: {value}",
  "atomic.vault.loading": "Carregando repositório…",
  "atomic.vault.noProject": "Abra um projeto para ver seu repositório.",
  "atomic.vault.empty.title": "O repositório está vazio",
  "atomic.vault.empty.description": "Nenhuma intenção ou memória está registrada para este projeto.",
  'atomic.views.pickerLabel': 'Selecionar uma visualização',
  'atomic.views.none': 'Nenhuma visualização',
  'atomic.view.current': 'Atual',
  'atomic.view.changeCount': 'Alterações: {count}',
  'atomic.status.added': 'Adicionado',
  'atomic.status.modified': 'Modificado',
  'atomic.status.deleted': 'Excluído',
  'atomic.status.renamed': 'Renomeado',
  ...
  'atomic.section.attestation': 'Atestação',
  'atomic.attestation.vendor': 'Fornecedor',
  'atomic.attestation.model': 'Modelo',
  'atomic.attestation.tool': 'Ferramenta',
  'atomic.attestation.type': 'Tipo',
  'atomic.attestation.tokens': 'Tokens',
  'atomic.attestation.tokensValue': 'Entrada {input} · Saída {output} · Total {total}',
  'atomic.attestation.cost': 'Custo',
  'atomic.attestation.session': 'Sessão',
  'atomic.attestation.finishReason': 'Motivo de conclusão',
  'atomic.attestation.steps': 'Etapas',
  'atomic.attestation.metadata': 'Metadados',
  'atomic.state.loading': 'Carregando o repositório Atomic…',
  'atomic.state.initialError.title': 'Não foi possível carregar o repositório Atomic',
  'atomic.state.initialError.description': 'Verifique o repositório e tente novamente.',
  'atomic.state.refreshError': 'Falha ao atualizar. Os dados carregados anteriormente continuam sendo exibidos.',
  'atomic.state.clean': 'A cópia de trabalho está limpa.',
  'atomic.state.noHistory': 'Não há alterações registradas nesta visualização.',
  'atomic.state.loadingDetail': 'Carregando detalhes da alteração…',
  'atomic.state.noDiff': 'Nenhum patch está disponível.',
  'atomic.state.loadingProvenance': 'Carregando procedência…',
  'atomic.state.noProvenance': 'Não há procedência disponível para esta alteração.',
  'atomic.state.selectChange': 'Selecione um caminho de trabalho ou uma alteração do histórico para inspecionar o patch.',
  'atomic.unavailable.cli.title': 'A CLI do Atomic não está instalada',
  'atomic.unavailable.cli.description': 'Instale o Atomic para inspecionar este repositório.',
  'atomic.unavailable.repository.title': 'Este não é um repositório Atomic',
  'atomic.unavailable.repository.description': 'Abra um diretório inicializado como repositório Atomic.',
  'atomic.unavailable.unsupported.title': 'O Atomic não está disponível neste ambiente',
  'atomic.unavailable.unsupported.description': 'Use um ambiente compatível com acesso somente para leitura ao Atomic.',
  'atomic.unavailable.error.title': 'O repositório Atomic não está disponível',
  'atomic.unavailable.error.description': 'Não foi possível inspecionar o repositório.',
  'vscodeLayout.actions.atomicAria': 'Abrir repositório Atomic',
