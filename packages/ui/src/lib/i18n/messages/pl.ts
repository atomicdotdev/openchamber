...
export const dict: Record<I18nKey, string> = {
  ...
  'contextRail.surface.notes.description': 'Intencje skarbca Atomic i pochodne wspomnienia dla projektu',
  ...
  'contextRail.surface.atomic.description': 'Przeglądaj repozytorium Atomic tylko do odczytu',
  'contextRail.surface.provenance.description': 'Prześledź pełny łańcuch pochodzenia zmiany',
  'atomic.provenanceChain.title': 'Łańcuch pochodzenia',
  'atomic.provenanceChain.tabLabel': 'Pochodzenie {hash}',
  'atomic.provenanceChain.open': 'Otwórz łańcuch pochodzenia',
  'atomic.ledger.kind.goal': 'Cel',
  'atomic.ledger.kind.exploration': 'Eksploracja',
  'atomic.ledger.kind.execution': 'Wykonanie',
  'atomic.ledger.kind.commitment': 'Zatwierdzenie',
  'atomic.ledger.kind.todo': 'Zadanie',
  'atomic.ledger.kind.verification': 'Weryfikacja',
  'atomic.ledger.kind.patchProposal': 'Propozycja poprawki',
  'atomic.ledger.kind.llmResponse': 'Odpowiedź',
  'atomic.ledger.agentWithVendor': '{agent} ({vendor})',
  'atomic.ledger.counts': '{nodes} węzłów · {edges} krawędzi · {changes} zmian',
  'atomic.ledger.noNodes': 'Ta tura nie zarejestrowała węzłów decyzyjnych.',
  'atomic.ledger.empty.title': 'Brak łańcucha pochodzenia',
  'atomic.ledger.empty.description': 'Ta zmiana nie ma zarejestrowanego dziennika decyzji.',
  'atomic.title': 'Repozytorium Atomic',
  'atomic.action.refresh': 'Odśwież',
  'atomic.section.changes': 'Zmiany',
  'atomic.section.history': 'Historia',
  'atomic.section.provenance': 'Pochodzenie',
  'atomic.vault.section.intents': 'Intencje',
  'atomic.vault.section.otherMemories': 'Inne wspomnienia',
  'atomic.vault.derivedMemories': 'Pochodne wspomnienia',
  'atomic.vault.derivedCount': '{count} pochodnych',
  'atomic.vault.attested': 'Poświadczone',
  'atomic.vault.field.why': 'Dlaczego',
  'atomic.vault.field.acceptanceCriteria': 'Kryteria akceptacji',
  'atomic.vault.field.tasks': 'Zadania',
  'atomic.vault.field.scopeIn': 'W zakresie',
  'atomic.vault.field.scopeOut': 'Poza zakresem',
  'atomic.vault.field.constraints': 'Ograniczenia',
  'atomic.vault.field.verifiedBy': 'Zweryfikowane przez: {value}',
  'atomic.vault.field.evidence': 'Dowody: {value}',
  'atomic.vault.loading': 'Wczytywanie skarbca…',
  'atomic.vault.noProject': 'Otwórz projekt, aby zobaczyć jego skarbiec.',
  'atomic.vault.empty.title': 'Skarbiec jest pusty',
  'atomic.vault.empty.description': 'Dla tego projektu nie zapisano żadnych intencji ani wspomnień.',
  ...
  'atomic.status.deleted': 'Usunięto',
  'atomic.status.renamed': 'Zmieniono nazwę',
  'atomic.status.untracked': 'Nieśledzony',
  'atomic.status.conflicted': 'Konflikt',
  'atomic.change.sequence': 'Kolejność {sequence}',
  'atomic.change.hash': 'Zmiana',
  'atomic.change.author': 'Autor',
  'atomic.change.state': 'Stan',
  'atomic.section.attestation': 'Poświadczenie',
  'atomic.attestation.vendor': 'Dostawca',
  'atomic.attestation.model': 'Model',
  'atomic.attestation.tool': 'Narzędzie',
  'atomic.attestation.type': 'Typ',
  'atomic.attestation.tokens': 'Tokeny',
  'atomic.attestation.tokensValue': 'Wej. {input} · Wyj. {output} · Razem {total}',
  'atomic.attestation.cost': 'Koszt',
  'atomic.attestation.session': 'Sesja',
  'atomic.attestation.finishReason': 'Powód zakończenia',
  'atomic.attestation.steps': 'Kroki',
  'atomic.attestation.metadata': 'Metadane',
  'atomic.state.loading': 'Ładowanie repozytorium Atomic…',
  'atomic.state.initialError.title': 'Nie udało się załadować repozytorium Atomic',
  'atomic.state.initialError.description': 'Sprawdź repozytorium i spróbuj ponownie.',
  'atomic.state.refreshError': 'Odświeżanie nie powiodło się. Nadal są wyświetlane wcześniej załadowane dane.',
  'atomic.state.clean': 'Kopia robocza jest czysta.',
  'atomic.state.noHistory': 'W tym widoku nie zapisano żadnych zmian.',
  'atomic.state.loadingDetail': 'Ładowanie szczegółów zmiany…',
  'atomic.state.noDiff': 'Brak dostępnej poprawki.',
  'atomic.state.loadingProvenance': 'Ładowanie pochodzenia…',
  'atomic.state.noProvenance': 'Brak informacji o pochodzeniu tej zmiany.',
  'atomic.state.selectChange': 'Wybierz ścieżkę roboczą lub zmianę historyczną, aby przejrzeć poprawkę.',
  'atomic.unavailable.cli.title': 'Atomic CLI nie jest zainstalowane',
  'atomic.unavailable.cli.description': 'Zainstaluj Atomic, aby przejrzeć to repozytorium.',
  'atomic.unavailable.repository.title': 'To nie jest repozytorium Atomic',
  'atomic.unavailable.repository.description': 'Otwórz katalog zainicjowany jako repozytorium Atomic.',
  'atomic.unavailable.unsupported.title': 'Atomic jest niedostępne w tym środowisku',
  'atomic.unavailable.unsupported.description': 'Użyj środowiska obsługującego dostęp tylko do odczytu do Atomic.',
  'atomic.unavailable.error.title': 'Repozytorium Atomic jest niedostępne',
  'atomic.unavailable.error.description': 'Nie udało się przejrzeć repozytorium.',
  'vscodeLayout.actions.atomicAria': 'Otwórz repozytorium Atomic',
