...
export const dict: Record<I18nKey, string> = {
  ...
  'contextRail.surface.notes.description': '프로젝트의 Atomic 볼트 인텐트와 파생 메모리',
  ...
  'contextRail.surface.atomic.description': '읽기 전용 Atomic 저장소 검사',
  'contextRail.surface.provenance.description': '변경의 전체 출처 체인 따라가기',
  'atomic.provenanceChain.title': '출처 체인',
  'atomic.provenanceChain.tabLabel': '출처 {hash}',
  'atomic.provenanceChain.open': '출처 체인 열기',
  'atomic.ledger.kind.goal': '목표',
  'atomic.ledger.kind.exploration': '탐색',
  'atomic.ledger.kind.execution': '실행',
  'atomic.ledger.kind.commitment': '커밋',
  'atomic.ledger.kind.todo': '할 일',
  'atomic.ledger.kind.verification': '검증',
  'atomic.ledger.kind.patchProposal': '패치 제안',
  'atomic.ledger.kind.llmResponse': '응답',
  'atomic.ledger.agentWithVendor': '{agent} ({vendor})',
  'atomic.ledger.counts': '노드 {nodes}개 · 엣지 {edges}개 · 변경 {changes}개',
  'atomic.ledger.noNodes': '이 턴에는 결정 노드가 기록되지 않았습니다.',
  'atomic.ledger.empty.title': '출처 체인 없음',
  'atomic.ledger.empty.description': '이 변경에는 기록된 결정 원장이 없습니다.',
  'atomic.title': 'Atomic 저장소',
  'atomic.action.refresh': '새로 고침',
  'atomic.section.changes': '변경 사항',
  'atomic.section.history': '기록',
  'atomic.section.provenance': '출처',
  'atomic.vault.section.intents': '인텐트',
  'atomic.vault.section.otherMemories': '기타 메모리',
  'atomic.vault.derivedMemories': '파생 메모리',
  'atomic.vault.derivedCount': '파생 {count}개',
  'atomic.vault.attested': '증명됨',
  'atomic.vault.field.why': '이유',
  'atomic.vault.field.acceptanceCriteria': '수용 기준',
  'atomic.vault.field.tasks': '작업',
  'atomic.vault.field.scopeIn': '범위 포함',
  'atomic.vault.field.scopeOut': '범위 제외',
  'atomic.vault.field.constraints': '제약',
  'atomic.vault.field.verifiedBy': '검증자: {value}',
  'atomic.vault.field.evidence': '근거: {value}',
  'atomic.vault.loading': '볼트를 불러오는 중…',
  'atomic.vault.noProject': '볼트를 보려면 프로젝트를 여세요.',
  'atomic.vault.empty.title': '볼트가 비어 있습니다',
  'atomic.vault.empty.description': '이 프로젝트에 기록된 인텐트나 메모리가 없습니다.',
  ...
  'atomic.status.deleted': '삭제됨',
  'atomic.status.renamed': '이름 변경됨',
  ...
  'atomic.section.attestation': '증명',
  'atomic.attestation.vendor': '공급업체',
  'atomic.attestation.model': '모델',
  'atomic.attestation.tool': '도구',
  'atomic.attestation.type': '유형',
  'atomic.attestation.tokens': '토큰',
  'atomic.attestation.tokensValue': '입력 {input} · 출력 {output} · 합계 {total}',
  'atomic.attestation.cost': '비용',
  'atomic.attestation.session': '세션',
  'atomic.attestation.finishReason': '종료 사유',
  'atomic.attestation.steps': '단계',
  'atomic.attestation.metadata': '메타데이터',
  'atomic.state.loading': 'Atomic 저장소를 불러오는 중…',
  'atomic.state.initialError.title': 'Atomic 저장소를 불러올 수 없습니다',
  'atomic.state.initialError.description': '저장소를 확인하고 다시 시도하세요.',
  'atomic.state.refreshError': '새로 고치지 못했습니다. 이전에 불러온 데이터를 계속 표시합니다.',
  'atomic.state.clean': '작업 복사본에 변경 사항이 없습니다.',
  'atomic.state.noHistory': '이 뷰에 기록된 변경 사항이 없습니다.',
  'atomic.state.loadingDetail': '변경 세부 정보를 불러오는 중…',
  'atomic.state.noDiff': '사용 가능한 패치가 없습니다.',
  'atomic.state.loadingProvenance': '출처를 불러오는 중…',
  'atomic.state.noProvenance': '이 변경에 사용할 수 있는 출처가 없습니다.',
  'atomic.state.selectChange': '작업 경로나 이전 변경을 선택하여 패치를 검사하세요.',
  'atomic.unavailable.cli.title': 'Atomic CLI가 설치되지 않았습니다',
  'atomic.unavailable.cli.description': '이 저장소를 검사하려면 Atomic을 설치하세요.',
  'atomic.unavailable.repository.title': 'Atomic 저장소가 아닙니다',
  'atomic.unavailable.repository.description': 'Atomic 저장소로 초기화된 디렉터리를 여세요.',
  'atomic.unavailable.unsupported.title': '이 런타임에서는 Atomic을 사용할 수 없습니다',
  'atomic.unavailable.unsupported.description': 'Atomic 읽기 전용 접근을 지원하는 런타임을 사용하세요.',
  'atomic.unavailable.error.title': 'Atomic 저장소를 사용할 수 없습니다',
  'atomic.unavailable.error.description': '저장소를 검사할 수 없습니다.',
  'vscodeLayout.actions.atomicAria': 'Atomic 저장소 열기',
