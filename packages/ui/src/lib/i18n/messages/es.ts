...
export const dict: Record<I18nKey, string> = {
  ...
  "contextRail.surface.notes.description": "Intenciones del repositorio Atomic y memorias derivadas del proyecto",
  ...
  'contextRail.surface.atomic.description': 'Inspeccionar el repositorio Atomic en modo de solo lectura',
  'contextRail.surface.provenance.description': 'Seguir la cadena de procedencia completa de un cambio',
  'atomic.provenanceChain.title': 'Cadena de procedencia',
  'atomic.provenanceChain.tabLabel': 'Procedencia {hash}',
  'atomic.provenanceChain.open': 'Abrir la cadena de procedencia',
  'atomic.ledger.kind.goal': 'Objetivo',
  'atomic.ledger.kind.exploration': 'Exploración',
  'atomic.ledger.kind.execution': 'Ejecución',
  'atomic.ledger.kind.commitment': 'Compromiso',
  'atomic.ledger.kind.todo': 'Tarea',
  'atomic.ledger.kind.verification': 'Verificación',
  'atomic.ledger.kind.patchProposal': 'Propuesta de parche',
  'atomic.ledger.kind.llmResponse': 'Respuesta',
  'atomic.ledger.agentWithVendor': '{agent} ({vendor})',
  'atomic.ledger.counts': '{nodes} nodos · {edges} aristas · {changes} cambios',
  'atomic.ledger.noNodes': 'Este turno no registró nodos de decisión.',
  'atomic.ledger.empty.title': 'Sin cadena de procedencia',
  'atomic.ledger.empty.description': 'Este cambio no tiene un registro de decisiones.',
  'atomic.title': 'Repositorio Atomic',
  'atomic.action.refresh': 'Actualizar',
  'atomic.section.changes': 'Cambios',
  'atomic.section.history': 'Historial',
  'atomic.section.provenance': 'Procedencia',
  "atomic.vault.section.intents": "Intenciones",
  "atomic.vault.section.otherMemories": "Otras memorias",
  "atomic.vault.derivedMemories": "Memorias derivadas",
  "atomic.vault.derivedCount": "{count} derivadas",
  "atomic.vault.attested": "Certificada",
  "atomic.vault.field.why": "Motivo",
  "atomic.vault.field.acceptanceCriteria": "Criterios de aceptación",
  "atomic.vault.field.tasks": "Tareas",
  "atomic.vault.field.scopeIn": "En el alcance",
  "atomic.vault.field.scopeOut": "Fuera del alcance",
  "atomic.vault.field.constraints": "Restricciones",
  "atomic.vault.field.verifiedBy": "Verificado por: {value}",
  "atomic.vault.field.evidence": "Evidencia: {value}",
  "atomic.vault.loading": "Cargando repositorio…",
  "atomic.vault.noProject": "Abre un proyecto para ver su repositorio.",
  "atomic.vault.empty.title": "El repositorio está vacío",
  "atomic.vault.empty.description": "No hay intenciones ni memorias registradas para este proyecto.",
  'atomic.views.pickerLabel': 'Seleccionar una vista',
  'atomic.views.none': 'Sin vistas',
  'atomic.view.current': 'Actual',
  'atomic.view.changeCount': 'Cambios: {count}',
  'atomic.status.added': 'Añadido',
  'atomic.status.modified': 'Modificado',
  'atomic.status.deleted': 'Eliminado',
  'atomic.status.renamed': 'Renombrado',
  'atomic.status.untracked': 'Sin seguimiento',
  'atomic.status.conflicted': 'Conflicto',
  'atomic.change.sequence': 'Secuencia {sequence}',
  'atomic.change.hash': 'Cambio',
  'atomic.change.author': 'Autor',
  'atomic.change.state': 'Estado',
  'atomic.section.attestation': 'Atestación',
  'atomic.attestation.vendor': 'Proveedor',
  'atomic.attestation.model': 'Modelo',
  'atomic.attestation.tool': 'Herramienta',
  'atomic.attestation.type': 'Tipo',
  'atomic.attestation.tokens': 'Tokens',
  'atomic.attestation.tokensValue': 'Entrada {input} · Salida {output} · Total {total}',
  'atomic.attestation.cost': 'Costo',
  'atomic.attestation.session': 'Sesión',
  'atomic.attestation.finishReason': 'Motivo de finalización',
  'atomic.attestation.steps': 'Pasos',
  'atomic.attestation.metadata': 'Metadatos',
  'atomic.state.loading': 'Cargando el repositorio Atomic…',
  'atomic.state.initialError.title': 'No se pudo cargar el repositorio Atomic',
  'atomic.state.initialError.description': 'Comprueba el repositorio e inténtalo de nuevo.',
  'atomic.state.refreshError': 'La actualización falló. Se siguen mostrando los datos cargados anteriormente.',
  'atomic.state.clean': 'La copia de trabajo está limpia.',
  'atomic.state.noHistory': 'No hay cambios registrados en esta vista.',
  'atomic.state.loadingDetail': 'Cargando detalles del cambio…',
  'atomic.state.noDiff': 'No hay ningún parche disponible.',
  'atomic.state.loadingProvenance': 'Cargando procedencia…',
  'atomic.state.noProvenance': 'No hay procedencia disponible para este cambio.',
  'atomic.state.selectChange': 'Selecciona una ruta de trabajo o un cambio histórico para inspeccionar su parche.',
  'atomic.unavailable.cli.title': 'La CLI de Atomic no está instalada',
  'atomic.unavailable.cli.description': 'Instala Atomic para inspeccionar este repositorio.',
  'atomic.unavailable.repository.title': 'Este no es un repositorio Atomic',
  'atomic.unavailable.repository.description': 'Abre un directorio inicializado como repositorio Atomic.',
  'atomic.unavailable.unsupported.title': 'Atomic no está disponible en este entorno',
  'atomic.unavailable.unsupported.description': 'Usa un entorno compatible con el acceso de solo lectura a Atomic.',
  'atomic.unavailable.error.title': 'El repositorio Atomic no está disponible',
  'atomic.unavailable.error.description': 'No se pudo inspeccionar el repositorio.',
  'vscodeLayout.actions.atomicAria': 'Abrir repositorio Atomic',
