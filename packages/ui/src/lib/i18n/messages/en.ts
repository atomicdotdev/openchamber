...
export const dict = {
  ...
  'contextRail.surface.notes.description': 'Atomic vault intents and derived memories for the project',
  ...
  'contextRail.surface.atomic.description': 'Inspect the read-only Atomic repository',
  'contextRail.surface.provenance.description': 'Follow a change\u2019s full provenance chain',
  'atomic.provenanceChain.title': 'Provenance chain',
  'atomic.provenanceChain.tabLabel': 'Provenance {hash}',
  'atomic.provenanceChain.open': 'Open provenance chain',
  'atomic.ledger.kind.goal': 'Goal',
  'atomic.ledger.kind.exploration': 'Exploration',
  'atomic.ledger.kind.execution': 'Execution',
  'atomic.ledger.kind.commitment': 'Commitment',
  'atomic.ledger.kind.todo': 'Todo',
  'atomic.ledger.kind.verification': 'Verification',
  'atomic.ledger.kind.patchProposal': 'Patch proposal',
  'atomic.ledger.kind.llmResponse': 'Response',
  'atomic.ledger.agentWithVendor': '{agent} ({vendor})',
  'atomic.ledger.counts': '{nodes} nodes · {edges} edges · {changes} changes',
  'atomic.ledger.noNodes': 'This turn recorded no decision nodes.',
  'atomic.ledger.empty.title': 'No provenance chain',
  'atomic.ledger.empty.description': 'This change has no recorded decision ledger.',
  'atomic.title': 'Atomic repository',
  'atomic.action.refresh': 'Refresh',
  'atomic.section.changes': 'Changes',
  'atomic.section.history': 'History',
  'atomic.section.provenance': 'Provenance',
  'atomic.vault.section.intents': 'Intents',
  'atomic.vault.section.otherMemories': 'Other memories',
  'atomic.vault.derivedMemories': 'Derived memories',
  'atomic.vault.derivedCount': '{count} derived',
  'atomic.vault.attested': 'Attested',
  'atomic.vault.field.why': 'Why',
  'atomic.vault.field.acceptanceCriteria': 'Acceptance criteria',
  'atomic.vault.field.tasks': 'Tasks',
  'atomic.vault.field.scopeIn': 'In scope',
  'atomic.vault.field.scopeOut': 'Out of scope',
  'atomic.vault.field.constraints': 'Constraints',
  'atomic.vault.field.verifiedBy': 'Verified by: {value}',
  'atomic.vault.field.evidence': 'Evidence: {value}',
  'atomic.vault.loading': 'Loading vault…',
  'atomic.vault.noProject': 'Open a project to view its vault.',
  'atomic.vault.empty.title': 'The vault is empty',
  'atomic.vault.empty.description': 'No intents or memories are recorded for this project.',
  ...
  'atomic.status.deleted': 'Deleted',
  'atomic.status.renamed': 'Renamed',
  'atomic.status.untracked': 'Untracked',
  'atomic.status.conflicted': 'Conflict',
  'atomic.change.sequence': 'Sequence {sequence}',
  'atomic.change.hash': 'Change',
  'atomic.change.author': 'Author',
  'atomic.change.state': 'State',
  'atomic.section.attestation': 'Attestation',
  'atomic.attestation.vendor': 'Vendor',
  'atomic.attestation.model': 'Model',
  'atomic.attestation.tool': 'Tool',
  'atomic.attestation.type': 'Type',
  'atomic.attestation.tokens': 'Tokens',
  'atomic.attestation.tokensValue': 'In {input} · Out {output} · Total {total}',
  'atomic.attestation.cost': 'Cost',
  'atomic.attestation.session': 'Session',
  'atomic.attestation.finishReason': 'Finish reason',
  'atomic.attestation.steps': 'Steps',
  'atomic.attestation.metadata': 'Metadata',
  'atomic.state.loading': 'Loading Atomic repository…',
  'atomic.state.initialError.title': 'Atomic repository could not be loaded',
  'atomic.state.initialError.description': 'Check the repository and try again.',
  'atomic.state.refreshError': 'Refresh failed. Previously loaded repository data is still shown.',
  'atomic.state.clean': 'The working copy is clean.',
  'atomic.state.noHistory': 'No changes are recorded in this view.',
  'atomic.state.loadingDetail': 'Loading change details…',
  'atomic.state.noDiff': 'No patch is available.',
  'atomic.state.loadingProvenance': 'Loading provenance…',
  'atomic.state.noProvenance': 'No provenance is available for this change.',
  'atomic.state.selectChange': 'Select a working path or historical change to inspect its patch.',
  'atomic.unavailable.cli.title': 'Atomic CLI is not installed',
  'atomic.unavailable.cli.description': 'Install Atomic to inspect this repository.',
  'atomic.unavailable.repository.title': 'This is not an Atomic repository',
  'atomic.unavailable.repository.description': 'Open a directory initialized as an Atomic repository.',
  'atomic.unavailable.unsupported.title': 'Atomic is unavailable in this runtime',
  'atomic.unavailable.unsupported.description': 'Use a runtime that supports read-only Atomic repository access.',
  'atomic.unavailable.error.title': 'Atomic repository is unavailable',
  'atomic.unavailable.error.description': 'The repository could not be inspected.',
  'vscodeLayout.actions.atomicAria': 'Open Atomic repository',
