...
export const dict: Record<I18nKey, string> = {
  ...
  "contextRail.surface.notes.description": "Наміри сховища Atomic та похідні спогади для проєкту",
  ...
  'contextRail.surface.atomic.description': 'Переглянути репозиторій Atomic лише для читання',
  'contextRail.surface.provenance.description': 'Простежити повний ланцюг походження зміни',
  'atomic.provenanceChain.title': 'Ланцюг походження',
  'atomic.provenanceChain.tabLabel': 'Походження {hash}',
  'atomic.provenanceChain.open': 'Відкрити ланцюг походження',
  'atomic.ledger.kind.goal': 'Мета',
  'atomic.ledger.kind.exploration': 'Дослідження',
  'atomic.ledger.kind.execution': 'Виконання',
  'atomic.ledger.kind.commitment': 'Фіксація',
  'atomic.ledger.kind.todo': 'Завдання',
  'atomic.ledger.kind.verification': 'Перевірка',
  'atomic.ledger.kind.patchProposal': 'Пропозиція патча',
  'atomic.ledger.kind.llmResponse': 'Відповідь',
  'atomic.ledger.agentWithVendor': '{agent} ({vendor})',
  'atomic.ledger.counts': '{nodes} вузлів · {edges} ребер · {changes} змін',
  'atomic.ledger.noNodes': 'Цей хід не зафіксував вузлів рішень.',
  'atomic.ledger.empty.title': 'Немає ланцюга походження',
  'atomic.ledger.empty.description': 'Ця зміна не має записаного журналу рішень.',
  'atomic.title': 'Репозиторій Atomic',
  'atomic.action.refresh': 'Оновити',
  'atomic.section.changes': 'Зміни',
  'atomic.section.history': 'Історія',
  'atomic.section.provenance': 'Походження',
  'atomic.vault.section.intents': 'Наміри',
  'atomic.vault.section.otherMemories': 'Інші спогади',
  'atomic.vault.derivedMemories': 'Похідні спогади',
  'atomic.vault.derivedCount': '{count} похідних',
  'atomic.vault.attested': 'Засвідчено',
  'atomic.vault.field.why': 'Навіщо',
  'atomic.vault.field.acceptanceCriteria': 'Критерії приймання',
  'atomic.vault.field.tasks': 'Завдання',
  'atomic.vault.field.scopeIn': 'У межах',
  'atomic.vault.field.scopeOut': 'Поза межами',
  'atomic.vault.field.constraints': 'Обмеження',
  'atomic.vault.field.verifiedBy': 'Перевірено: {value}',
  'atomic.vault.field.evidence': 'Докази: {value}',
  'atomic.vault.loading': 'Завантаження сховища…',
  'atomic.vault.noProject': 'Відкрийте проєкт, щоб переглянути його сховище.',
  'atomic.vault.empty.title': 'Сховище порожнє',
  'atomic.vault.empty.description': 'Для цього проєкту не записано жодних намірів чи спогадів.',
  ...
  'atomic.status.deleted': 'Видалено',
  'atomic.status.renamed': 'Перейменовано',
  'atomic.status.untracked': 'Не відстежується',
  'atomic.status.conflicted': 'Конфлікт',
  'atomic.change.sequence': 'Послідовність {sequence}',
  'atomic.change.hash': 'Зміна',
  'atomic.change.author': 'Автор',
  'atomic.change.state': 'Стан',
  'atomic.section.attestation': 'Засвідчення',
  'atomic.attestation.vendor': 'Постачальник',
  'atomic.attestation.model': 'Модель',
  'atomic.attestation.tool': 'Інструмент',
  'atomic.attestation.type': 'Тип',
  'atomic.attestation.tokens': 'Токени',
  'atomic.attestation.tokensValue': 'Вхід {input} · Вихід {output} · Разом {total}',
  'atomic.attestation.cost': 'Вартість',
  'atomic.attestation.session': 'Сеанс',
  'atomic.attestation.finishReason': 'Причина завершення',
  'atomic.attestation.steps': 'Кроки',
  'atomic.attestation.metadata': 'Метадані',
  'atomic.state.loading': 'Завантаження репозиторію Atomic…',
  'atomic.state.initialError.title': 'Не вдалося завантажити репозиторій Atomic',
  'atomic.state.initialError.description': 'Перевірте репозиторій і повторіть спробу.',
  'atomic.state.refreshError': 'Не вдалося оновити. Раніше завантажені дані залишаються на екрані.',
  'atomic.state.clean': 'Робоча копія чиста.',
  'atomic.state.noHistory': 'У цьому поданні немає записаних змін.',
  'atomic.state.loadingDetail': 'Завантаження відомостей про зміну…',
  'atomic.state.noDiff': 'Патч недоступний.',
  'atomic.state.loadingProvenance': 'Завантаження походження…',
  'atomic.state.noProvenance': 'Для цієї зміни немає даних про походження.',
  'atomic.state.selectChange': 'Виберіть робочий шлях або історичну зміну, щоб переглянути патч.',
  'atomic.unavailable.cli.title': 'Atomic CLI не встановлено',
  'atomic.unavailable.cli.description': 'Встановіть Atomic, щоб переглянути цей репозиторій.',
  'atomic.unavailable.repository.title': 'Це не репозиторій Atomic',
  'atomic.unavailable.repository.description': 'Відкрийте каталог, ініціалізований як репозиторій Atomic.',
  'atomic.unavailable.unsupported.title': 'Atomic недоступний у цьому середовищі',
  'atomic.unavailable.unsupported.description': 'Скористайтеся середовищем із підтримкою доступу до Atomic лише для читання.',
  'atomic.unavailable.error.title': 'Репозиторій Atomic недоступний',
  'atomic.unavailable.error.description': 'Не вдалося переглянути репозиторій.',
  'vscodeLayout.actions.atomicAria': 'Відкрити репозиторій Atomic',
