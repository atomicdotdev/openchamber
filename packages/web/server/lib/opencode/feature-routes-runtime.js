...
import { registerAtomicRoutes } from '../atomic/routes.js';
import { createAtomicRuntime } from '../atomic/runtime.js';
...
export const createFeatureRoutesRuntime = (dependencies) => {
  ...
  const registerRoutes = async (app, routeDependencies) => {
    ...
    registerAtomicRoutes(app, {
      atomicRuntime: createAtomicRuntime(),
      resolveProjectDirectory,
    });
